...
export const OBJECTIVES: LearningObjective[] = [
  ...
  // Age 9 (Band B) — remaining 9 CAPS Gr 4 topics
  { id: 'll.plant_reproduction', strand: 'life_and_living',      topic: 'Plant Reproduction',  title: 'Pollination lets flowers make seeds',     capsRef: 'CAPS Gr 4: Life & Living', band: 'B', prerequisites: [], anchoringPhenomenon: 'Does a flower need a bee to make seeds?', languages: ['en', 'zu'] },
  { id: 'll.nutrition',          strand: 'life_and_living',      topic: 'Human Nutrition',     title: 'A balanced plate has different food groups', capsRef: 'CAPS Gr 4: Life & Living', band: 'B', prerequisites: [], anchoringPhenomenon: 'Which foods give energy, build the body, or protect it?', languages: ['en', 'zu'] },
  { id: 'mm.particles',          strand: 'matter_and_materials', topic: 'Particle Model',      title: 'Heating makes particles move faster',     capsRef: 'CAPS Gr 4: Matter & Materials', band: 'B', prerequisites: [], anchoringPhenomenon: 'What happens to tiny particles when you heat them?', languages: ['en', 'zu'] },
  { id: 'mm.structures',         strand: 'matter_and_materials', topic: 'Strong Structures',   title: 'Shape and material decide how strong something is', capsRef: 'CAPS Gr 4: Matter & Materials', band: 'B', prerequisites: [], anchoringPhenomenon: 'Which shape is strongest — a square or a triangle?', languages: ['en', 'zu'] },
  { id: 'ec.stored_energy',      strand: 'energy_and_change',    topic: 'Stored Energy',       title: 'Food, batteries and fuel store energy',   capsRef: 'CAPS Gr 4: Energy & Change', band: 'B', prerequisites: [], anchoringPhenomenon: 'What things store energy we can use later?', languages: ['en', 'zu'] },
  { id: 'ec.sound_vibration',    strand: 'energy_and_change',    topic: 'Sound & Vibration',   title: 'A bigger vibration makes a louder sound', capsRef: 'CAPS Gr 4: Energy & Change', band: 'B', prerequisites: [], anchoringPhenomenon: 'Does hitting a drum harder make it louder?', languages: ['en', 'zu'] },
  { id: 'eb.solar_system',       strand: 'earth_and_beyond',     topic: 'Solar System',        title: 'Planets farther from the sun have longer years', capsRef: 'CAPS Gr 4: Earth & Beyond', band: 'B', prerequisites: [], anchoringPhenomenon: 'Does a planet far from the sun have a longer year?', languages: ['en', 'zu'] },
  ...
  { id: 'll.skeletons',        strand: 'life_and_living',      topic: 'Animal Skeletons',            title: 'Skeletons can be inside (bones) or outside (shell)', capsRef: 'CAPS Gr 5: Life & Living', band: 'C', prerequisites: [], anchoringPhenomenon: 'Where does a crab keep its skeleton?', languages: ['en', 'zu'] },
  { id: 'll.food_webs',        strand: 'life_and_living',      topic: 'Food Webs',                   title: 'Energy flows from the sun to producers to consumers', capsRef: 'CAPS Gr 5: Life & Living', band: 'C', prerequisites: [], anchoringPhenomenon: 'Where does the energy in your food first come from?', languages: ['en', 'zu'] },
  { id: 'mm.metal_uses',       strand: 'matter_and_materials', topic: 'Uses of Metals',              title: 'We choose metals for the property a job needs',     capsRef: 'CAPS Gr 5: Matter & Materials', band: 'C', prerequisites: [], anchoringPhenomenon: 'Why are wires metal but window frames sometimes not?', languages: ['en', 'zu'] },
  { id: 'mm.processing',       strand: 'matter_and_materials', topic: 'Processing Materials',        title: 'Raw materials are processed into useful products',   capsRef: 'CAPS Gr 5: Matter & Materials', band: 'C', prerequisites: [], anchoringPhenomenon: 'What does sand become when we melt it?', languages: ['en', 'zu'] },
  { id: 'ec.fuels',            strand: 'energy_and_change',    topic: 'Stored Energy in Fuels',      title: 'Fuels store energy that is released when they burn',  capsRef: 'CAPS Gr 5: Energy & Change', band: 'C', prerequisites: [], anchoringPhenomenon: 'What do wood, coal and petrol have in common?', languages: ['en', 'zu'] },
  { id: 'ec.switches',         strand: 'energy_and_change',    topic: 'Circuits with Switches',      title: 'A switch completes or breaks a circuit',             capsRef: 'CAPS Gr 5: Energy & Change', band: 'C', prerequisites: [], anchoringPhenomenon: 'How does a switch turn a light on and off?', languages: ['en', 'zu'] },
  { id: 'eb.erosion',          strand: 'earth_and_beyond',     topic: 'Soil Erosion',                title: 'Plants protect soil from being washed away',         capsRef: 'CAPS Gr 5: Earth & Beyond', band: 'C', prerequisites: [], anchoringPhenomenon: 'Does rain wash away bare soil faster than planted soil?', languages: ['en', 'zu'] },
  ...
  { id: 'll.nutrients',         strand: 'life_and_living',      topic: 'Nutrients in Food',        title: 'Foods are grouped by their main nutrient',          capsRef: 'CAPS Gr 6: Life & Living', band: 'C11', prerequisites: [], anchoringPhenomenon: 'Is bread mostly carbohydrate or protein?', languages: ['en', 'zu'] },
  { id: 'll.food_preservation', strand: 'life_and_living',      topic: 'Food Preservation',        title: 'Drying, freezing and canning stop food spoiling',   capsRef: 'CAPS Gr 6: Life & Living', band: 'C11', prerequisites: [], anchoringPhenomenon: 'How do we make food last longer?', languages: ['en', 'zu'] },
  { id: 'mm.changes_of_state',  strand: 'matter_and_materials', topic: 'Changes of State',         title: 'Adding or removing heat changes the state of matter', capsRef: 'CAPS Gr 6: Matter & Materials', band: 'C11', prerequisites: [], anchoringPhenomenon: 'What makes ice melt and water vapour condense?', languages: ['en', 'zu'] },
  { id: 'mm.dissolving',        strand: 'matter_and_materials', topic: 'Solutions & Dissolving',   title: 'A solute dissolves faster in a hot solvent',        capsRef: 'CAPS Gr 6: Matter & Materials', band: 'C11', prerequisites: [], anchoringPhenomenon: 'Does sugar dissolve faster in hot or cold water?', languages: ['en', 'zu'] },
  { id: 'ec.conductors',        strand: 'energy_and_change',    topic: 'Conductors & Insulators',  title: 'Conductors let current flow; insulators block it',  capsRef: 'CAPS Gr 6: Energy & Change', band: 'C11', prerequisites: [], anchoringPhenomenon: 'Which materials let a bulb light in a circuit?', languages: ['en', 'zu'] },
  { id: 'ec.levers',            strand: 'energy_and_change',    topic: 'Levers & Simple Machines', title: 'A lever lets us lift a heavy load with less effort', capsRef: 'CAPS Gr 6: Energy & Change', band: 'C11', prerequisites: [], anchoringPhenomenon: 'Where do you push a lever to lift with less effort?', languages: ['en', 'zu'] },
  { id: 'eb.solar_order',       strand: 'earth_and_beyond',     topic: 'The Solar System',         title: 'Planets orbit the sun in order of distance',        capsRef: 'CAPS Gr 6: Earth & Beyond', band: 'C11', prerequisites: [], anchoringPhenomenon: 'Which planet is closest to the sun?', languages: ['en', 'zu'] },
  ...
  { id: 'll.classification',          strand: 'life_and_living',      topic: 'Classifying Living Things', title: 'Living things are grouped as animals, plants and fungi', capsRef: 'CAPS Gr 7: Life & Living', band: 'C12', prerequisites: [], anchoringPhenomenon: 'Is a mushroom a plant, an animal, or something else?', languages: ['en', 'zu'] },
  { id: 'll.plant_reproduction_c12',  strand: 'life_and_living',      topic: 'Reproduction in Plants',   title: 'Flowering plants make seeds in a set order', capsRef: 'CAPS Gr 7: Life & Living', band: 'C12', prerequisites: [], anchoringPhenomenon: 'How does a flower turn into a fruit with seeds?', languages: ['en', 'zu'] },
  { id: 'mm.elements_compounds',      strand: 'matter_and_materials', topic: 'Elements, Compounds & Mixtures', title: 'Matter is made of elements, compounds and mixtures', capsRef: 'CAPS Gr 7: Matter & Materials', band: 'C12', prerequisites: [], anchoringPhenomenon: 'Is water a single thing, or made of smaller parts?', languages: ['en', 'zu'] },
  { id: 'mm.atom',                    strand: 'matter_and_materials', topic: 'Inside the Atom',          title: 'Atoms have protons, neutrons and electrons', capsRef: 'CAPS Gr 7: Matter & Materials', band: 'C12', prerequisites: [], anchoringPhenomenon: 'What is everything made of, deep down?', languages: ['en', 'zu'] },
  { id: 'ec.energy_types',            strand: 'energy_and_change',    topic: 'Potential & Kinetic Energy', title: 'Energy is stored (potential) or moving (kinetic)', capsRef: 'CAPS Gr 7: Energy & Change', band: 'C12', prerequisites: [], anchoringPhenomenon: 'Where does a stretched bow get its power?', languages: ['en', 'zu'] },
  { id: 'ec.energy_renewable',        strand: 'energy_and_change',    topic: 'Renewable Energy',         title: 'Energy sources are renewable or non-renewable', capsRef: 'CAPS Gr 7: Energy & Change', band: 'C12', prerequisites: [], anchoringPhenomenon: 'Will the world ever run out of sunlight?', languages: ['en', 'zu'] },
  { id: 'eb.sun_earth_moon',          strand: 'earth_and_beyond',     topic: 'Sun, Earth & Moon',        title: 'Stars make light, planets orbit stars, moons orbit planets', capsRef: 'CAPS Gr 7: Earth & Beyond', band: 'C12', prerequisites: [], anchoringPhenomenon: 'Does the Sun make its own light, or reflect it?', languages: ['en', 'zu'] },
...
export const ACTIVITIES: LearningActivity[] = [
  ...
  { id: 'll.pr.b.do',  objectiveId: 'll.plant_reproduction', band: 'B', fiveEStage: 'explore', kind: 'game',       generatorKey: 'plantRepro',   config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'Find a flower; look for pollen and visiting insects.' },
  { id: 'll.nut.b.do', objectiveId: 'll.nutrition',          band: 'B', fiveEStage: 'explore', kind: 'quiz',       generatorKey: 'nutrition',    config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'At dinner, name an energy food and a protecting food.' },
  { id: 'mm.par.b.do', objectiveId: 'mm.particles',          band: 'B', fiveEStage: 'explore', kind: 'simulation', generatorKey: 'particles',    config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'Watch ice melt in a warm room — particles gained energy.' },
  { id: 'mm.str.b.do', objectiveId: 'mm.structures',         band: 'B', fiveEStage: 'explore', kind: 'simulation', generatorKey: 'structures',   config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'Fold paper into shapes; which holds the most books?' },
  { id: 'ec.se.b.do',  objectiveId: 'ec.stored_energy',      band: 'B', fiveEStage: 'explore', kind: 'quiz',       generatorKey: 'storedEnergy',  config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'Name 3 things at home that store energy.' },
  { id: 'ec.snd.b.do', objectiveId: 'ec.sound_vibration',    band: 'B', fiveEStage: 'explore', kind: 'simulation', generatorKey: 'soundVibration', config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'Put rice on a drum; hit it and watch it jump.' },
  ...
  { id: 'll.skel.c.do', objectiveId: 'll.skeletons',        band: 'C', fiveEStage: 'explore', kind: 'game',       generatorKey: 'skeletons',  config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'Feel the bones in your arm; find a creature with a shell.' },
  { id: 'll.web.c.do',  objectiveId: 'll.food_webs',        band: 'C', fiveEStage: 'explore', kind: 'game',       generatorKey: 'foodWeb',    config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'Trace a meal back to the sun.' },
  { id: 'mm.use.c.do',  objectiveId: 'mm.metal_uses',       band: 'C', fiveEStage: 'explore', kind: 'game',       generatorKey: 'metalUses',  config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'Find a metal object — why metal and not plastic?' },
  { id: 'mm.proc.c.do', objectiveId: 'mm.processing',       band: 'C', fiveEStage: 'explore', kind: 'game',       generatorKey: 'processing', config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'A window started as sand; bricks started as clay.' },
  { id: 'ec.fuel.c.do', objectiveId: 'ec.fuels',            band: 'C', fiveEStage: 'explore', kind: 'game',       generatorKey: 'fuels',      config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'How does your home cook — gas, wood, or electricity?' },
  { id: 'ec.sw.c.do',   objectiveId: 'ec.switches',         band: 'C', fiveEStage: 'explore', kind: 'simulation', generatorKey: 'switchCircuit', config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'Flick a light switch: ON closes the circuit, OFF breaks it.' },
  { id: 'eb.ero.c.do',  objectiveId: 'eb.erosion',          band: 'C', fiveEStage: 'explore', kind: 'simulation', generatorKey: 'erosion',    config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'After rain, spot soil washed off bare ground.' },
  ...
  { id: 'll.nut.c11.do',  objectiveId: 'll.nutrients',         band: 'C11', fiveEStage: 'explore', kind: 'game',       generatorKey: 'nutrients',        config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'Find a carbohydrate, a protein and a fruit at dinner.' },
  { id: 'll.pres.c11.do', objectiveId: 'll.food_preservation', band: 'C11', fiveEStage: 'explore', kind: 'game',       generatorKey: 'foodPreservation', config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'Find a dried, a frozen and a canned food at home.' },
  { id: 'mm.cos.c11.do',  objectiveId: 'mm.changes_of_state',  band: 'C11', fiveEStage: 'explore', kind: 'game',       generatorKey: 'changesOfState',   config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'Watch an ice cube melt — heat changes its state.' },
  { id: 'mm.dis.c11.do',  objectiveId: 'mm.dissolving',        band: 'C11', fiveEStage: 'explore', kind: 'simulation', generatorKey: 'dissolving',       config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'Stir sugar into cold and warm water — which is faster?' },
  { id: 'ec.con.c11.do',  objectiveId: 'ec.conductors',        band: 'C11', fiveEStage: 'explore', kind: 'game',       generatorKey: 'conductors',       config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'A cable is metal inside (conductor), plastic outside (insulator).' },
  { id: 'ec.lev.c11.do',  objectiveId: 'ec.levers',            band: 'C11', fiveEStage: 'explore', kind: 'simulation', generatorKey: 'levers',           config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'Find a lever: bottle opener, scissors, see-saw.' },
  { id: 'eb.sol.c11.do',  objectiveId: 'eb.solar_order',       band: 'C11', fiveEStage: 'explore', kind: 'game',       generatorKey: 'solarOrder',       config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'At night, spot a planet — it does not twinkle.' },
  ...
  { id: 'll.class.c12.do',   objectiveId: 'll.classification',         band: 'C12', fiveEStage: 'explore', kind: 'game',       generatorKey: 'classification',  config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'Sort photos of an animal, a plant and a mushroom.' },
  { id: 'll.repro.c12.do',   objectiveId: 'll.plant_reproduction_c12', band: 'C12', fiveEStage: 'explore', kind: 'game',       generatorKey: 'plantReproC12',  config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'Cut open a fruit and find the seeds inside.' },
  { id: 'mm.elem.c12.do',    objectiveId: 'mm.elements_compounds',     band: 'C12', fiveEStage: 'explore', kind: 'game',       generatorKey: 'elementsCompounds', config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'Stir salt into water — a mixture you can taste.' },
  { id: 'mm.atom.c12.do',    objectiveId: 'mm.atom',                   band: 'C12', fiveEStage: 'explore', kind: 'simulation', generatorKey: 'buildAtom',      config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'Everything around you is built from tiny atoms.' },
  { id: 'ec.etypes.c12.do',  objectiveId: 'ec.energy_types',           band: 'C12', fiveEStage: 'explore', kind: 'game',       generatorKey: 'energyTypes',    config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'Hold a ball high (stored), drop it (moving energy).' },
  { id: 'ec.esrc.c12.do',    objectiveId: 'ec.energy_renewable',       band: 'C12', fiveEStage: 'explore', kind: 'game',       generatorKey: 'energySources',  config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'Hunt for ways to save energy at home.' },
  { id: 'eb.sem.c12.do',     objectiveId: 'eb.sun_earth_moon',         band: 'C12', fiveEStage: 'explore', kind: 'game',       generatorKey: 'sunEarthMoon',   config: {}, assets: { audioByLang: { en: [], zu: [] } }, estimatedSeconds: 720, caregiverPrompt: 'On a clear night, spot stars and the Moon.' },
